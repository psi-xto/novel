...
Погрузитесь в мир кибербезопасности через историю Алексея — стажера в отделе мониторинга угроз.
Принимайте решения в реальных сценариях: анализ ложных срабатываний, расследование фишинговых атак,
выявление внутренних угроз. Каждый выбор влияет на развитие ваших навыков и исход расследований.

ИГРОВЫЕ ОСОБЕННОСТИ:
• 3 главы с нарастающей сложностью
• 4 возможные концовки
• Мини-игры на основе реальных задач SOC
• Система прокачки аналитических навыков

РАЗРАБОТАНО В РАМКАХ УЧЕБНОГО ПРОЕКТА
Уральский федеральный университет, 2025

Команда: Константинов Г.А., Павленко П.С., 
Кондрыкинский Г.В., Морозов А.И., Вотинова М.А.
""")
...
define build.name = "the-phantom-data"
...
define config.save_directory = "novel-1758169596"
